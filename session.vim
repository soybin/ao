...
set ruler
set runtimepath=~/.vim,~/.vim/pack/plugins/start/lightline,~/.vim/pack/pablo/start/vim-glsl,~/.vim/pack/pablo/start/lightline,~/.vim/pack/pablo/start/auto-pairs,/usr/share/vim/vimfiles,/usr/share/vim/vim82,~/.vim/pack/pablo/start/vim-glsl/after,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=2
set noshowmode
set smartindent
...
silent! normal! zE
let s:l = 151 - ((1 * winheight(0) + 15) / 30)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((12 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 65 + 69) / 139)
exe 'vert 2resize ' . ((&columns * 1 + 69) / 139)
argglobal
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
...
wincmd w
argglobal
if bufexists("src/shader.cpp") | buffer src/shader.cpp | else | edit src/shader.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
